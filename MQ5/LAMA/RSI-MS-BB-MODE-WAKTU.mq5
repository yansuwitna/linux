...
void OnTick()
{
   ...
   string currentTime = "Current Time: " + TimeToString(TimeCurrent(), TIME_DATE | TIME_MINUTES) + "\n";
   info += currentTime;
   ...
   // Mengubah mode otomatis berdasarkan kondisi pasar
   string marketMode = "Mode: ";
